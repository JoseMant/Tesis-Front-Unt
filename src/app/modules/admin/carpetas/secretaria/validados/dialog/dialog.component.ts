...
export class CarpetaSecretariaValidadosDialogComponent implements OnInit
{
    ...
    constructor(
        ...
        public matDialogRef: MatDialogRef<CarpetaSecretariaValidadosDialogComponent>,
    ...
    ngOnInit(): void
    {
        ...
        this.composeForm = this._formBuilder.group({
            ...
            subject: ['NOTIFICACIÓN DE OBSERVACIÓN DEL TRÁMITE N° ' + this.data.nro_tramite, [Validators.required]],
