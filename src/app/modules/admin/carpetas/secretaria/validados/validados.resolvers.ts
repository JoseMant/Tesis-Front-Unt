...
export class CarpetasSecretariaValidadoResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class CarpetasSecretariaValidadosResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        // debugger;
        return this._carpetasService.getCarpetasValidadosSecretaria(Number(route.paramMap.get('idResolucion')))
                   .pipe(
