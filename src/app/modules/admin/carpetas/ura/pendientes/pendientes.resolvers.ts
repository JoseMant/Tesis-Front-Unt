...
export class CarpetaSecretariaPendienteResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class CarpetasURAPendientesResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._carpetasService.getCarpetasPendientesImpresion(Number(route.paramMap.get('idResolucion')))
                   .pipe(
