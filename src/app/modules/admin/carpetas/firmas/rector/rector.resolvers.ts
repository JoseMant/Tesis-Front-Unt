...
export class CarpetaFirmaRectorResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class CarpetasFirmasRectorResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        // debugger;
        return this._carpetasService.getCarpetasFirmasRector(Number(route.paramMap.get('idResolucion')))
                   .pipe(
