...
@Component({
    selector       : 'carpetas-firmas-decano-list',
    templateUrl    : './list.component.html',
    styles         : [
        /* language=SCSS */
        `
            .carpetas-firmas-decano-grid {
...
export class CarpetasFirmasDecanoListComponent implements OnInit, AfterViewInit, OnDestroy
{
   ...
   constructor(
        ...
        this.searchInputControl.valueChanges
            .pipe(
                ...
                switchMap((query) => {
                    ...
                    return this._carpetasService.getCarpetasFirmaDecano(data, 0, this._paginator.pageSize, this._sort.active, this._sort.direction, query);
                }),
                map(() => {
        ...
        if ( this._sort && this._paginator )
        {
            ...
            merge(this._sort.sortChange, this._paginator.page).pipe(
                switchMap(() => {
                    ...
                    return this._carpetasService.getCarpetasFirmaDecano(data, this._paginator.pageIndex, this._paginator.pageSize, this._sort.active, this._sort.direction, this.searchInputControl.value);
                }),
                map(() => {
                    this.isLoading = false;
                })
    ...
    firmaDecano() {
        ...
        this._carpetasService.firmaDecano(data.idResolucion).subscribe((response) => {
            this.alert = {
                type   : 'success',
