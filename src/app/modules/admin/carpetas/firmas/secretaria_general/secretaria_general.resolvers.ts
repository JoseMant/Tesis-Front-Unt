...
export class CarpetaFirmaSecretariaResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class CarpetasFirmasSecretariaGeneralResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._carpetasService.getCarpetasFirmasSecretaria(Number(route.paramMap.get('idResolucion')))
            .pipe(
