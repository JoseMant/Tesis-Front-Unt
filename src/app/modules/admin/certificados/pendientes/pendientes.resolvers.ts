...
export class CertificadoPendienteResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class CertificadosPendientesResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._certificadosService.getCertificadosPendientes();
    }
}
