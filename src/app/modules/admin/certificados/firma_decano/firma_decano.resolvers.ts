...
export class CertificadoFirmaDecanoResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class CertificadosFirmaDecanoResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._certificadosService.getCertificadosFirmaDecano();
    }
}
