            ...
            .pipe(
                ...
                switchMap((query) => {
                    ...
                    if (this._paginator && this._sort) {
                        ...
                        return this._certificadosService.getCertificadosFirmaDecano(0, this._paginator.pageSize, this._sort.active, this._sort.direction, query);
                    }
                    else
                        return this._certificadosService.getCertificadosFirmaDecano(0, 100, 'created_at', 'desc', query);
                }),
                map(() => {
            ...
            merge(this._sort.sortChange, this._paginator.page).pipe(
                switchMap(() => {
                    ...
                    if(this.searchInputControl.value ){
                        return this._certificadosService.getCertificadosFirmaDecano(this._paginator.pageIndex, this._paginator.pageSize, this._sort.active, this._sort.direction, this.searchInputControl.value);
                    }else{
                        return this._certificadosService.getCertificadosFirmaDecano(this._paginator.pageIndex, this._paginator.pageSize, this._sort.active, this._sort.direction);
                    }
                }),
