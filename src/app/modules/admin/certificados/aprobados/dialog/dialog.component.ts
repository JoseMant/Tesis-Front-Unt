...
export class CertificadoAprobadoDialogComponent implements OnInit
{
    ...
    constructor(
        ...
        public matDialogRef: MatDialogRef<CertificadoAprobadoDialogComponent>,
    ...
    ngOnInit(): void
    {
        ...
        this.composeForm = this._formBuilder.group({
            ...
            subject: ['NOTIFICACIÓN DE RETRASO DEL TRÁMITE DE CERTIFICADO N° ' + this.data.nro_tramite, [Validators.required]],
    ...
    send(): void
    {
        ...
        this._certificadoService.sendNotification(data.idTramite, data).subscribe((updatedCertificado) => {
