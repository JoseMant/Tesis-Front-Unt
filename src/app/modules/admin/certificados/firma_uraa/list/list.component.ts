            ...
            .pipe(
                ...
                switchMap((query) => {
                    ...
                    if (this._paginator && this._sort) {
                        ...
                        return this._certificadosService.getCertificadosFirmaURAA(0, this._paginator.pageSize, this._sort.active, this._sort.direction, query);
                    }
                    else
                        return this._certificadosService.getCertificadosFirmaURAA(0, 100, 'created_at', 'desc', query);
                }),
                map(() => {
    ...
    ngAfterViewInit(): void
    {
        if ( this._sort && this._paginator )
        {
            ...
            merge(this._sort.sortChange, this._paginator.page).pipe(
                switchMap(() => {
                    this.isLoading = true;
                    // return this._certificadosService.getCertificadosFirmaURAA(this._paginator.pageIndex, this._paginator.pageSize, this._sort.active, this._sort.direction);
                    if(this.searchInputControl.value ){
                        return this._certificadosService.getCertificadosFirmaURAA(this._paginator.pageIndex, this._paginator.pageSize, this._sort.active, this._sort.direction, this.searchInputControl.value);
                    }else{
                        return this._certificadosService.getCertificadosFirmaURAA(this._paginator.pageIndex, this._paginator.pageSize, this._sort.active, this._sort.direction);
                    }
                }),
