...
export class CertificadoFinalizadoResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class CertificadosFinalizadosResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._certificadosService.getCertificadosFinalizados();
    }
}
