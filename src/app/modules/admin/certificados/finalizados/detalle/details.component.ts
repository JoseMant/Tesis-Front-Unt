...
export class CertificadoFinalizadoDetalleComponent implements OnInit, OnDestroy
{
    ...
    correccionCertificado(): void
    {
        ...
        this._certificadoService.correccionCertificado(certificado.idTramite).subscribe(() => {
