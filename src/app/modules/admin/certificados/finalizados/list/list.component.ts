...
@Component({
    selector       : 'certificados-finalizados-list',
    templateUrl    : './list.component.html',
    styles         : [
        /* language=SCSS */
        `
            .certificados-finalizados-grid {
...
export class CertificadosFinalizadosListComponent implements OnInit, AfterViewInit, OnDestroy
{
