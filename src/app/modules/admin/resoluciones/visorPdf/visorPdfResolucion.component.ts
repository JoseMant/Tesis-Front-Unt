...
@Component({
    ...
    templateUrl: './visorPdfResolucion.component.html',
    styles: [
        `
            pdf-viewer {
                height: 65vh;
...
export class VisorPdfResolucionComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<VisorPdfResolucionComponent>,
    ) {}
