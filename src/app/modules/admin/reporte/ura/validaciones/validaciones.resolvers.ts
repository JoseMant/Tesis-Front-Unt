...
export class GradoURAValidacionResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class GradosURAValidacionesResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._gradosService.getGradosValidacionURA();
    }
}
