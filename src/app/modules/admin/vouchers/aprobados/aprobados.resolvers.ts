...
export class VoucherAprobadoResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class VouchersAprobadosResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._vouchersService.getVouchersAprobados();
    }
}
