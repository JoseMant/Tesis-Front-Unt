    ...
    styles         : [
        ...
        `
            .docentes-finalizados-grid {
                ...
                @screen lg {
                    grid-template-columns: 48px 100px auto 200px 200px 150px 250px 150px 100px;
                }
            }
            .fondo_snackbar {
...
export class DocenteFinalizadosListComponent implements OnInit, AfterViewInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        this.searchInputControl.valueChanges
            .pipe(
                ...
                switchMap((query) => {
                    this.isLoading = true;
                    return this._docenteService.getDocentesFinalizados(0, 100, 'fecha', 'desc', query);
    ...
    cambioPagina(evento): void {
        if(this._sort.active) {
            this._docenteService.getDocentesFinalizados(evento.pageIndex, evento.pageSize, this._sort.active, this._sort.direction, this.searchInputControl.value).subscribe();
        }
        else {
            this._docenteService.getDocentesFinalizados(evento.pageIndex, evento.pageSize, 'nro_tramite', 'asc', this.searchInputControl.value).subscribe();
        }
    }
