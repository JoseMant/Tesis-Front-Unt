...
export class TituloFacultadDiplomaResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class TitulosFacultadDiplomasResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._titulosService.getTitulosDiplomasFacultad();
    }
}