...
export class TituloFacultadRevalidadoResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class TitulosFacultadRevalidadosResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._titulosService.getTitulosRevalidadosFacultad();
    }
}
