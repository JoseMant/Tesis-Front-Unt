...
export class GradoFirmaDecanoResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class GradosFirmaDecanoResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._gradosService.getGradosFirmaDecano();
    }
}
