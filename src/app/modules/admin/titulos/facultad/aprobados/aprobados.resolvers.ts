...
export class TituloFacultadAprobadoResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class TitulosFacultadAprobadosResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._titulosService.getTitulosAprobadosFacultad();
    }
}
