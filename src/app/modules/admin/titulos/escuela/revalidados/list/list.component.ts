...
export class TitulosEscuelaRevalidadosListComponent implements OnInit, AfterViewInit, OnDestroy
{
            ...
            .pipe(
                ...
                switchMap((query) => {
                    ...
                    if (this._paginator && this._sort) {
                        ...
                        return this._titulosService.getTitulosRevalidados(0, this._paginator.pageSize, this._sort.active, this._sort.direction, query);
                    }
                    else
