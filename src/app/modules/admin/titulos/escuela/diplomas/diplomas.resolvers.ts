...
export class TituloEscuelaDiplomaResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class TitulosEscuelaDiplomasResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._titulosService.getTitulosDiplomasEscuela();
    }
}
