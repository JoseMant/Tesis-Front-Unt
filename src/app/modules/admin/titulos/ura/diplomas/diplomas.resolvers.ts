...
export class TituloURADiplomaResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class TitulosURADiplomasResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._titulosService.getTitulosDiplomasURA();
    }
}