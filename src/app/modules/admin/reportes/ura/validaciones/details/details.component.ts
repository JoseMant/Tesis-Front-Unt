...
// import { RequisitosDialogComponent } from 'app/modules/admin/reportes/dialogReq/dialogReq.component';

@Component({
    selector       : 'reporte-ura-details',
...
export class ReporteURAValidacionDetalleComponent implements OnInit, OnDestroy
{
    ...
    reporte: ReporteInterface | null = null;
    allreportes: ReporteInterface[];
    reporteForm: FormGroup;
    contador: number = 4;
    private _unsubscribeAll: Subject<any> = new Subject<any>();
    newReporte: boolean = false;
    /**
     * Constructor
     */
    constructor(
    ...
    ngOnInit(): void
    {
        ...
        // Get the reporte
        this._reporteService.reporte$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((reporte: ReporteInterface) => {
                console.log(reporte);
                // Get the reporte
