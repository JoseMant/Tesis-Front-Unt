...
export class ReporteFacultadValidadoResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class ReportesFacultadValidadosResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._reportesService.getReportesFacultad();
    }
}
