    ...
    styles         : [
        ...
        `
            .reportes-validados-grid {
                ...
                @screen lg {
                    grid-template-columns: 48px 112px 300px 190px 96px 190px auto;
                }
            }
            .fondo_snackbar {
...
export class ReportesFacultadValidadosListComponent implements OnInit, AfterViewInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        this.searchInputControl.valueChanges
            .pipe(
                ...
                switchMap((query) => {
                    this.isLoading = true;
                    return this._reportesService.getReportesFacultad(0, 10, 'fecha', 'desc', query);
                }),
                map(() => {
    ...
    ngAfterViewInit(): void
    {
        if ( this._sort && this._paginator )
        {
            ...
            merge(this._sort.sortChange, this._paginator.page).pipe(
                switchMap(() => {
                    this.isLoading = true;
                    return this._reportesService.getReportesFacultad(this._paginator.pageIndex, this._paginator.pageSize, this._sort.active, this._sort.direction);
                }),
                map(() => {
                    this.isLoading = false;
                })
