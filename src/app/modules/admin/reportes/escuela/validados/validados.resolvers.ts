...
export class ReporteEscuelaValidadoResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class ReportesEscuelaValidadosResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._reportesService.getReportesEscuela();
    }
}
