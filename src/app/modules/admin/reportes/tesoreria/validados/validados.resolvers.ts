...
export class ReporteTesoreriaValidadoResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class ReportesTesoreriaValidadosResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._reportesService.getReportesTesoreria();
    }
}
