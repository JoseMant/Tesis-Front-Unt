...
export class CarnetFinalizadoResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class SedesCarnetsRecibidosResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class CarnetsFinalizadosResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._carnetsService.getCarnetsFinalizados();
    }
}
