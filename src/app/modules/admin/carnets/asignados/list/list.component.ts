...
@Component({
    selector       : 'carnets-asignados-list',
...
export class CarnetsAsignadosListComponent implements OnInit, AfterViewInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        this.searchInputControl.valueChanges
            .pipe(
                ...
                switchMap((query) => {
                    this.isLoading = true;
                    return this._carnetsService.getCarnetsAsignados(0, 10, 'fecha', 'desc', query);
                }),
                map(() => {
    ...
    //             const carnetAsignado = response.getRawValue();
    //             this._carnetsService.updateCarnet(carnetAsignado.idCarnet, carnetAsignado ).subscribe((updateNew) => {
    ...
    ngAfterViewInit(): void
    {
        if ( this._sort && this._paginator )
        {
            ...
            merge(this._sort.sortChange, this._paginator.page).pipe(
                switchMap(() => {
                    this.isLoading = true;
                    return this._carnetsService.getCarnetsAsignados(this._paginator.pageIndex, this._paginator.pageSize, this._sort.active, this._sort.direction);
                }),
                map(() => {
                    this.isLoading = false;
                })
