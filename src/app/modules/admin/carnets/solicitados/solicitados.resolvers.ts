...
export class CarnetSolicitadoResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class CarnetsSolicitadosResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._carnetsService.getCarnetsSolicitados();
    }
}
