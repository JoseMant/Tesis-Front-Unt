...
@Component({
    ...
    templateUrl: './visorPdfConstancia.component.html',
    styles: [
        `
            pdf-viewer {
                height: 65vh;
...
export class VisorPdfConstanciaComponent implements OnInit, OnDestroy {
    ...
    // Private
    //pdfSource  = "Constancia.pdf";
    private _unsubscribeAll: Subject<any> = new Subject<any>();
    constructor(
        @Inject(MAT_DIALOG_DATA) public data: any,
        public dialogRef: MatDialogRef<VisorPdfConstanciaComponent>,
    ...
    llenarDialog(data: any): void {
        ...
        this.formulario2.patchValue({
            ...
            idConstancia: data.idConstancia,
