...
export class HomeListComponent implements OnInit, AfterViewInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        // Get the brands
        this._homeService.brands$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((brands: HomeBrand[]) => {
        ...
        // Get the vendors
        this._homeService.vendors$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((vendors: HomeVendor[]) => {
        ...
        this.searchInputControl.valueChanges
            .pipe(
                ...
                switchMap((query) => {
                    this.closeDetails();
                    this.isLoading = true;
                    return this._homeService.getProducts(0, 10, 'created_at', 'desc', query);
                }),
                map(() => {
        ...
        if ( this._sort && this._paginator )
        {
            ...
            merge(this._sort.sortChange, this._paginator.page).pipe(
                switchMap(() => {
                    this.closeDetails();
                    this.isLoading = true;
                    return this._homeService.getProducts(this._paginator.pageIndex, this._paginator.pageSize, this._sort.active, this._sort.direction);
                }),
                map(() => {
                    this.isLoading = false;
                })
    ...
    toggleDetails(productId: number): void
    {
        ...
        if ( this.selectedProduct && this.selectedProduct.idTramite === productId )
        {
            // Close the details
            this.closeDetails();
            return;
        ...
        this._homeService.getProductById(productId)
            .subscribe((product) => {
     ...
     * @param tag
     */
    addTagToProduct(tag: HomeTag): void
    {
        // Add the tag
     ...
     * @param tag
     */
    removeTagFromProduct(tag: HomeTag): void
    {
        // Remove the tag
     ...
     * @param change
     */
    toggleProductTag(tag: HomeTag, change: MatCheckboxChange): void
    {
        if ( change.checked )
        {
            this.addTagToProduct(tag);
    ...
    {
        // Create the product
        this._homeService.createProduct().subscribe((newProduct) => {
    ...
    updateSelectedProduct(): void
    {
        ...
        this._homeService.updateProduct(product.id, product).subscribe(() => {
    ...
    deleteSelectedProduct(): void
    {
        ...
        confirmation.afterClosed().subscribe((result) => {
            ...
            if ( result === 'confirmed' )
            {
                ...
                this._homeService.deleteProduct(product.id).subscribe(() => {
