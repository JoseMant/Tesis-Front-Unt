...
import { Resolucion, Role, Tipo_Resolucion, Unidad } from 'app/modules/admin/masters/carpeta/resoluciones/resoluciones.types';
...
export class ResolucionesService
{
    ...
    {
        return this._httpClient.get<Resolucion[]>(environment.baseUrl + 'resoluciones/all', {
            params: {search,idTipo_resolucion:1}
        }).pipe(
            tap((resoluciones) => {
                this._resoluciones.next(resoluciones);
            })
