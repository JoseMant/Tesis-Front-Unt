...
export class IndicadorComponent implements OnInit, OnDestroy
{
    ...
    data: any;
    selectedIndicador: string = 'Certificados';
    ...
    {
        // Certificados - Indicador 1
        this.chartCertificadosInd1 = {
            chart      : {
                fontFamily: 'inherit',
                foreColor : 'inherit',
                height    : '100%',
            ...
            labels     : this.data.certificadosIndicador1.labels,
            legend     : {
                show: false
            },
            plotOptions: {
