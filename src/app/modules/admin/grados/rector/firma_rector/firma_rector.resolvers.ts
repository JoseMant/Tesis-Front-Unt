...
export class GradoFirmaRectorResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class GradosFirmaRectorResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._gradosService.getGradosFirmaRector();
    }
}
