...
export class GradoSecretariaObservadoResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class GradosSecretariaObservadosResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._gradosService.getGradosSecretariaObservados();
    }
}
