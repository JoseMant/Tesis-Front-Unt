...
export class GradoFacultadDiplomaResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class GradosFacultadDiplomasResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._gradosService.getGradosDiplomasFacultad();
    }
}