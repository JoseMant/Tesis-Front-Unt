...
export class GradoFacultadRevalidadoResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class GradosFacultadRevalidadosResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._gradosService.getGradosRevalidadosFacultad();
    }
}
