...
export class GradoFacultadAprobadoResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class GradosFacultadAprobadosResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._gradosService.getGradosAprobadosFacultad();
    }
}
