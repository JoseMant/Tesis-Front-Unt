...
@Component({
    selector       : 'grados-aprobados-list',
...
export class GradosFacultadAprobadosListComponent implements OnInit, AfterViewInit, OnDestroy
{
    ...
    cambioPagina(evento): void {
        if(this._sort.active) {
            this._gradosService.getGradosAprobadosFacultad(evento.pageIndex, evento.pageSize, this._sort.active, this._sort.direction, this.searchInputControl.value).subscribe();
        }
        else {
            this._gradosService.getGradosAprobadosFacultad(evento.pageIndex, evento.pageSize, 'nro_tramite', 'asc', this.searchInputControl.value).subscribe();
        }
    }
            ...
            merge(this._sort.sortChange, this._paginator.page).pipe(
                switchMap(() => {
                    ...
                    if(this.searchInputControl.value ){
                        return this._gradosService.getGradosAprobadosFacultad(this._paginator.pageIndex, this._paginator.pageSize, this._sort.active, this._sort.direction, this.searchInputControl.value);
                    }else{
                        return this._gradosService.getGradosAprobadosFacultad(this._paginator.pageIndex, this._paginator.pageSize, this._sort.active, this._sort.direction);
                    }
                }),
                map(() => {
                    this.isLoading = false;
