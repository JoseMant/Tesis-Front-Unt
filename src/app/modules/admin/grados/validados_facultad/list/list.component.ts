...
export class GradosValidadosFacultadListComponent implements OnInit, AfterViewInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        this.searchInputControl.valueChanges
            .pipe(
                ...
                switchMap((query) => {
                    this.isLoading = true;
                    return this._gradosService.getGradosValidadosFacultad(0, 10, 'fecha', 'desc', query);
                }),
                map(() => {
