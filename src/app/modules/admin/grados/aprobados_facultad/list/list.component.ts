...
export class GradosAprobadosFacultadListComponent implements OnInit, AfterViewInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        this.searchInputControl.valueChanges
            .pipe(
                ...
                switchMap((query) => {
                    this.isLoading = true;
                    return this._gradosService.getGradosAprobadosFacultad(0, 10, 'fecha', 'desc', query);
                }),
                map(() => {
