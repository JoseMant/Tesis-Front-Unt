...
export class GradoURADiplomaResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class GradosURADiplomasResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._gradosService.getGradosDiplomasURA();
    }
}