...
@Component({
    ...
    templateUrl: './visorPdfGrado.component.html',
    styles: [
        `
            pdf-viewer {
                height: 65vh;
...
export class VisorPdfGradoComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<VisorPdfGradoComponent>,
    ) {}
