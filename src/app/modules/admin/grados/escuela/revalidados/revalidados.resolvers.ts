...
export class GradoEscuelaRevalidadoResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class GradosEscuelaRevalidadosResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._gradosService.getGradosRevalidados();
    }
}
