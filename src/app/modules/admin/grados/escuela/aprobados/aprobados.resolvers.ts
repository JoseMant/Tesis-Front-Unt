...
export class GradoEscuelaAprobadoResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class GradosEscuelaAprobadosResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._gradosService.getGradosAprobados();
    }
}
