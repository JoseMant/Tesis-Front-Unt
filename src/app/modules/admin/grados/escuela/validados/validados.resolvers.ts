...
export class GradoEscuelaValidadoResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class GradosEscuelaValidadosResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._gradosService.getGradosValidados();
    }
}
