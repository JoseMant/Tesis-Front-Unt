...
export class GradoFinalizadoResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class GradosFinalizadosResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._gradosService.getGradosFinalizados();
    }
}
