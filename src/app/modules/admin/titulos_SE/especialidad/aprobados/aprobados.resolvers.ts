...
export class TituloEspecialidadAprobadoResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class TitulosEspecialidadAprobadosResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._titulosService.getTitulosAprobados();
    }
}
