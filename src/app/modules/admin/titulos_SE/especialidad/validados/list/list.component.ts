...
@Component({
    selector       : 'titulos_SE-validados-list',
    templateUrl    : './list.component.html',
    styles         : [
        /* language=SCSS */
        `
            .titulos_SE-validados-grid {
...
export class TitulosEspecialidadValidadosListComponent implements OnInit, AfterViewInit, OnDestroy
{
