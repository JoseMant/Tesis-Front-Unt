...
@Component({
    selector       : 'titulos_SE-revalidados-list',
    templateUrl    : './list.component.html',
    styles         : [
        /* language=SCSS */
        `
            .titulos_SE-revalidados-grid {
...
export class TitulosEspecialidadRevalidadosListComponent implements OnInit, AfterViewInit, OnDestroy
{
