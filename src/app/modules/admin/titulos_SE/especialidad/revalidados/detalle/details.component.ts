...
export class TituloEspecialidadRevalidadoDetalleComponent implements OnInit, OnDestroy
{
    ...
    listEstados = [
        ...
        {id: 1, value: 17, name: 'VALIDANDO DOCUMENTOS DEL ALUMNO EN LA ESPECIALIDAD'},
        {id: 2, value: 30, name: 'ADJUNTANDO DOCUMENTOS EN ESPECIALIDAD'}
    ];
