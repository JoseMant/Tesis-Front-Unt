...
export class TituloEspecialidadRevalidadoResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
// export class AllTitulosResolver implements Resolve<any>
// {
//     /**
//      * Constructor
//      */
...
//     resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<TituloInterface[]>
//     {
//         return this._titulosService.getAllTitulos();
//     }
// }
...
export class TitulosEspecialidadRevalidadosResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._titulosService.getTitulosRevalidados();
    }
}
