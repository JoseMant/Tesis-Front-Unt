...
export class TituloFacultadRevalidadoDetalleComponent implements OnInit, OnDestroy
{
    ...
    listEstados = [
        ...
        {id: 1, value: 20, name: 'VALIDANDO DOCUMENTOS DEL ALUMNO Y ESPECIALIDAD EN LA FACULTAD'},
    ...
    enviarEspecialidad(): void {
        ...
        // Update the contact on the server
        this._tituloService.sendEspecialidad(titulo.idTramite, titulo).subscribe(() => {
