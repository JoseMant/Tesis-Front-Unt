...
export class TituloFacultadValidadoResolver implements Resolve<any>
{
    /**
     * Constructor
     */
...
export class TitulosFacultadValidadosResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    {
        return this._titulosService.getTitulosValidadosFacultad();
    }
}
